...
const Instruction instructions[256] = {
    [0x00] = Instruction{INST_TYPE::IN_NOP, ADDR_MODE::AM_IMP},
    [0x01] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D16, REG_TYPE::RT_BC},
    [0x02] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_MR_R, REG_TYPE::RT_BC, REG_TYPE::RT_A},
    [0x03] = Instruction{INST_TYPE::IN_INC, ADDR_MODE::AM_R, REG_TYPE::RT_BC},
    [0x04] = Instruction{INST_TYPE::IN_INC, ADDR_MODE::AM_R, REG_TYPE::RT_B},
    [0x05] = Instruction{INST_TYPE::IN_DEC, ADDR_MODE::AM_R, REG_TYPE::RT_B},
    [0x06] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D8, REG_TYPE::RT_B},
    [0x07] = Instruction{INST_TYPE::IN_RLCA},
    [0x08] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_A16_R, REG_TYPE::RT_NONE, REG_TYPE::RT_SP},
    [0x09] = Instruction{INST_TYPE::IN_ADD, ADDR_MODE::AM_R_R, REG_TYPE::RT_HL, REG_TYPE::RT_BC},
    [0x0A] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_MR, REG_TYPE::RT_A, REG_TYPE::RT_BC},
    [0x0B] = Instruction{INST_TYPE::IN_DEC, ADDR_MODE::AM_R, REG_TYPE::RT_BC},
    [0x0C] = Instruction{INST_TYPE::IN_INC, ADDR_MODE::AM_R, REG_TYPE::RT_C},
    [0x0D] = Instruction{INST_TYPE::IN_DEC, ADDR_MODE::AM_R, REG_TYPE::RT_C},
    [0x0E] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D8, REG_TYPE::RT_C},
    [0x0F] = Instruction{INST_TYPE::IN_RRCA},
    [0x10] = Instruction{INST_TYPE::IN_STOP, ADDR_MODE::AM_IMP},
    [0x11] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D16, REG_TYPE::RT_DE},
    [0x12] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_MR_R, REG_TYPE::RT_DE, REG_TYPE::RT_A},
    [0x13] = Instruction{INST_TYPE::IN_INC, ADDR_MODE::AM_R, REG_TYPE::RT_DE},
    [0x14] = Instruction{INST_TYPE::IN_INC, ADDR_MODE::AM_R, REG_TYPE::RT_D},
    [0x15] = Instruction{INST_TYPE::IN_DEC, ADDR_MODE::AM_R, REG_TYPE::RT_D},
    [0x16] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D8, REG_TYPE::RT_D},
    [0x17] = Instruction{INST_TYPE::IN_RLA},
    [0x18] = Instruction{INST_TYPE::IN_JR, ADDR_MODE::AM_D8},
    [0x19] = Instruction{INST_TYPE::IN_ADD, ADDR_MODE::AM_R_R, REG_TYPE::RT_HL, REG_TYPE::RT_DE},
    [0x1A] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_MR, REG_TYPE::RT_A, REG_TYPE::RT_DE},
    [0x1B] = Instruction{INST_TYPE::IN_DEC, ADDR_MODE::AM_R, REG_TYPE::RT_DE},
    [0x1C] = Instruction{INST_TYPE::IN_INC, ADDR_MODE::AM_R, REG_TYPE::RT_E},
    [0x1D] = Instruction{INST_TYPE::IN_DEC, ADDR_MODE::AM_R, REG_TYPE::RT_E},
    [0x1E] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D8, REG_TYPE::RT_E},
    [0x1F] = Instruction{INST_TYPE::IN_RRA},
    [0x20] = Instruction{INST_TYPE::IN_JR, ADDR_MODE::AM_D8, REG_TYPE::RT_NONE, REG_TYPE::RT_NONE, COND_TYPE::CT_NZ},
    [0x21] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_R_D16, REG_TYPE::RT_HL},
    [0x22] = Instruction{INST_TYPE::IN_LD, ADDR_MODE::AM_HLI_R, REG_TYPE::RT_HL, REG_TYPE::RT_A},
/*
